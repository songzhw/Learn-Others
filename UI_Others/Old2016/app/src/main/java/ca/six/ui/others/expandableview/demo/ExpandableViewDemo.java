...
public class ExpandableViewDemo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        expandableViewLevel1.setOutsideContentLayout(topExpandableView.getLlayChildren());
        expandableViewLevel2.setOutsideContentLayout(topExpandableView.getLlayChildren(), expandableViewLevel1.getLlayChildren());
        expandableViewLevel3.setOutsideContentLayout(topExpandableView.getLlayChildren(), expandableViewLevel1.getLlayChildren(), expandableViewLevel2.getLlayChildren());
    ...
    private void createTopExpandableView() {
        ...
        topExpandableView.fillData(R.drawable.ic_launcher, getString(R.string.android_names), true);
    ...
    private void createMiddleExpandableView() {
        ...
        middleExpandableView.fillData(R.drawable.ic_launcher, getString(R.string.android_names), false);
    ...
    private void createInnerExpandableViewLevel1() {
        ...
        expandableViewLevel1.fillData(R.drawable.ic_launcher, getString(R.string.android_codes), false);
    ...
    private void createInnerExpandableViewLevel2() {
        ...
        expandableViewLevel2.fillData(R.drawable.ic_launcher, getString(R.string.android_names), false);
    ...
    private void createInnerExpandableViewLevel3() {
        ...
        expandableViewLevel3.fillData(R.drawable.ic_launcher, getString(R.string.android_codes), false);

...
interface WebApis {
    ...
    @GET("weather")
    fun getWeatherDetail(@Header("auth") key: String, @QueryMap params: java.util.HashMap<String, String>): Call<WeatherData>

    @GET("forecast")
    fun getWeatherForecasting(@Header("auth") key: String, @QueryMap params: HashMap<String, String>): Call<WeatherForecastData>
}
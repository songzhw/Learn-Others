...
public class StringUtils {
    ...
    //繁簡轉換
    public static String convertString2TranditionalChinese(String input, Context context) {
        ConversionType currentConversionType = ConversionType.S2TWP; //来自opencc库, 将简体转为繁体

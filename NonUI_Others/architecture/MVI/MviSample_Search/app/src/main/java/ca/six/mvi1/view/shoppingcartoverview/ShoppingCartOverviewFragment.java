...
public class ShoppingCartOverviewFragment
    ...
    @NonNull
    @Override
    public ShoppingCartOverviewPresenter createPresenter() {
        Timber.d("Create Presenter");
        return SampleApplication.getDependencyInjection(getActivity()).getShoppingCartPresenter();
    }

    @Override
    public Observable<Boolean> loadItemsIntent() {
        return Observable.just(true);
    }

    @Override
    public Observable<List<Product>> selectItemsIntent() {
    ...
    @Override
    public Observable<Product> removeItemIntent() {
    ...
    @Override
    public void render(List<ShoppingCartOverviewItem> itemsInShoppingCart) {

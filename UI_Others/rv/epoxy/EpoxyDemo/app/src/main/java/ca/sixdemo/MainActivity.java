...
import ca.sixdemo.models.CarouselModelGroup;
 ...
 */
public class MainActivity extends AppCompatActivity implements SampleController.AdapterCallbacks {
...
//        });
    ...
    EpoxyTouchHelper.initDragging(controller)
        ...
        .forVerticalList()
        .withTarget(CarouselModelGroup.class)
        .andCallbacks(new EpoxyTouchHelper.DragCallbacks<CarouselModelGroup>() {
